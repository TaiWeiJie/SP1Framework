...
enum EGAMESTATES
{
    ...
    S_WINSCREEN,
    S_PESTCONTROLSCREEN,
    S_DECIMATIONSCREEN, // for complete utter annihalation
    S_MENU,
    S_GUIDE,
    S_GAME,
    S_COUNT,
...
void renderDecimationscreen(); // renders an ultimate winning screen which set stage for 2 different winning outcomes
